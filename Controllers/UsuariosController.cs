...
namespace turismoTCC.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idUsuario,nome,email,senha,MyProperty")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idUsuario,nome,email,senha,MyProperty")] Usuario usuario)
        {
