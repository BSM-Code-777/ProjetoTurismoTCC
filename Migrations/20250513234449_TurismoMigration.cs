...
{
    /// <inheritdoc />
    public partial class TurismoMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    tipo = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    idPosicao = table.Column<int>(type: "int", nullable: false),
                    PosicaoidPosicao = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Localidade", x => x.idLocal);
                    table.ForeignKey(
                        name: "FK_Localidade_Posicao_PosicaoidPosicao",
                        column: x => x.PosicaoidPosicao,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Localidade_PosicaoidPosicao",
                table: "Localidade",
                column: "PosicaoidPosicao");
